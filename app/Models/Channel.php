...
class Channel extends Model
{
    ...
    protected $fillable = [
        'name', 'slug', 'notes',
        'user_id',
        'source_type', 'ingest_mode', 'source_url', 'reencode_ingest', 'youtube_cookies', 'youtube_po_token', 'ingest_port', 'rtmp_input_key', 'relay_pid',
        'current_source_id',
        ...
        'clock_position', 'clock_fontsize', 'clock_color', 'clock_format', 'clock_enabled', 'clock_x', 'clock_y', 'output_resolution',
